...
namespace DapperCRUD
{
    ...
    {
        SqlConnection sqlCon = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Studies;Integrated Security=True;Encrypt=False;TrustServerCertificate=True;");
        int contactId = 0;
        public Form1()
        {
            InitializeComponent();
